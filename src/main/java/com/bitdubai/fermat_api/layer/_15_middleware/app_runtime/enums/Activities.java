...
public enum Activities {
    ...
    CWP_WALLET_RUNTIME_BASIC_ALL_AVAILABLE_BALANCE ("basicBalanceActivity"),
    CWP_WALLET_RUNTIME_BASIC_ALL_CONTACTS_SEND ( "BasicSendToContactActivity"),
    CWP_WALLET_RUNTIME_BASIC_ALL_CONTACTS_NEW_SEND ( "BasicSendToNewContactActivity"),
    CWP_WALLET_RUNTIME_BASIC_ALL_CONTACTS_RECEIVE ( "BasicReceiveFromContactActivity"),
    CWP_WALLET_RUNTIME_BASIC_ALL_CONTACTS_NEW_RECEIVE ( "BasicReceiveFromNewContactActivity"),
